...
### Hardware Safety
This application has currently only been tested on a **Helix Floor** with **Firmware 3.80**. Always back up your Helix presets and settings before importing or testing any preset generated by this application. While the application takes precautions to stay within DSP limits, **I am** not responsible for any damage or unexpected behavior the generated presets may cause to your device. Always verify your signal chain and output levels before engaging your speakers or headphones. If a generated preset causes the hardware to lock up or become unresponsive, perform a factory reset using the official Line 6 procedure for your device. A factory reset may erase presets and settings, which is why a backup is essential.
