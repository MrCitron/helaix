...
### Hardware Safety
This application has currently only been tested on a **Helix Floor** with **Firmware 3.80**. Always back up your Helix presets and settings before importing or testing any preset generated by this application. If a generated preset causes the hardware to lock up or become unresponsive, follow [Line 6's recovery procedure](https://kb.line6.com/helix-rack-lt-fx-stomp-reset-procedures-and-troubleshooting-tricks) and try the least destructive recovery first: rebuild or reload your presets, or clear only the current preset. Use a full factory restore only as a last resort; it can erase presets, setlists, global settings, and IRs. While the application takes precautions to stay within DSP limits, **I am** not responsible for any damage or unexpected behavior the generated presets may cause to your device. Always verify your signal chain and output levels before engaging your speakers or headphones.
