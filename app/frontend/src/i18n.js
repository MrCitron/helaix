...
const translations = {
    en: {
        ...
        settings: {
            ...
            defaultInstrumentHint: "Select the default instrument for AI context (Guitar or Bass).",
    ...
    fr: {
        ...
        settings: {
            ...
            save: "Enregistrer",
            interfaceSection: "Interface",
            defaultInstrument: "Instrument par Défaut",
            defaultInstrumentHint: "Sélectionnez l'instrument par défaut pour l'IA (Guitare ou Basse).",
