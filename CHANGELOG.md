...
### Added
- **instruments**: add bass support and formalize Variax resolution

### Changed
- automate versioned releases
- strengthen pull request checklist
- **opencode**: integrate and setup opencode
- add CodeRabbit configuration and update docs
- add AGENTS.md and STYLEGUIDE.md for code consistency
- add PR template and contribution guidelines

### Fixed
- **variax**: align global model with snapshot zero
- **preset**: harden generated Helix presets for hardware
